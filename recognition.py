...
def analyse():
    ...
    # images_path = glob.glob(r"./test-sample5/*.jpg") + glob.glob(r"./test-sample5/*.png") + glob.glob(r"./test-sample5/*.jpeg")
    images_path = glob.glob(r"./test-sample5/sample1.png") + glob.glob(r"./test-sample5/sample2.png")
